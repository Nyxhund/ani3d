...
void scene_structure::display_frame()
{
    ...
    vec3 const axis_of_rotation_cube = { 1,1,0 };
    float const angle_of_rotation_cube = time / 2.0f;
    cube.model.rotation = rotation_axis_angle(axis_of_rotation_cube, angle_of_rotation_cube);
        // rotation_transform::from_axis_angle({ 0,0,1 }, std::sin(3 * time));
    ...
    sphere.texture.load_and_initialize_texture_2d_on_gpu(project::path+"assets/squirrel.jpg");
